...
namespace Appagenda2 {
    ...
    public partial class bdAgendaDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string Nome, string rua, string cep, string numero, string bairro) {
...
namespace Appagenda2.bdAgendaDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_rua = 1 AND [rua] IS NULL) OR ([rua] = @Original_rua)) AND ((@IsNull_cep = 1 AND [cep] IS NULL) OR ([cep] = @Original_cep)) AND ((@IsNull_numero = 1 AND [numero] IS NULL) OR ([numero] = @Original_numero)) AND ((@IsNull_bairro = 1 AND [bairro] IS NULL) OR ([bairro] = @Original_bairro)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Nome], [rua], [cep], [numero], [bairro]) VALUES (@Nom" +
                "e, @rua, @cep, @numero, @bairro);\r\nSELECT Id, Nome, rua, cep, numero, bairro FRO" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Nome] = @Nome, [rua] = @rua, [cep] = @cep, [numero] = @numero, [bairro] = @bairro WHERE (([Id] = @Original_Id) AND ((@IsNull_Nome = 1 AND [Nome] IS NULL) OR ([Nome] = @Original_Nome)) AND ((@IsNull_rua = 1 AND [rua] IS NULL) OR ([rua] = @Original_rua)) AND ((@IsNull_cep = 1 AND [cep] IS NULL) OR ([cep] = @Original_cep)) AND ((@IsNull_numero = 1 AND [numero] IS NULL) OR ([numero] = @Original_numero)) AND ((@IsNull_bairro = 1 AND [bairro] IS NULL) OR ([bairro] = @Original_bairro)));
SELECT Id, Nome, rua, cep, numero, bairro FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Appagenda2.Properties.Settings.Default.bdAgendaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nome, rua, cep, numero, bairro FROM dbo.[Table]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::Microsoft.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        Id, Nome, rua, cep, numero, bairro\r\nFROM            [Table]\r\nWHERE " +
                "       (Nome = @p)";
        ...
        public virtual int FillByNome(bdAgendaDataSet.TableDataTable dataTable, string p) {
        ...
        public virtual bdAgendaDataSet.TableDataTable GetDataByNome(string p) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((p == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        public virtual int Delete(int Original_Id, string Original_Nome, string Original_rua, string Original_cep, string Original_numero, string Original_bairro) {
        ...
        public virtual int Insert(string Nome, string rua, string cep, string numero, string bairro) {
            if ((Nome == null)) {
        ...
        public virtual int Update(string Nome, string rua, string cep, string numero, string bairro, int Original_Id, string Original_Nome, string Original_rua, string Original_cep, string Original_numero, string Original_bairro, int Id) {
            if ((Nome == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string rua, string cep, string numero, string bairro, int Original_Id, string Original_Nome, string Original_rua, string Original_cep, string Original_numero, string Original_bairro) {
            return this.Update(Nome, rua, cep, numero, bairro, Original_Id, Original_Nome, Original_rua, Original_cep, Original_numero, Original_bairro, Original_Id);
        }
    }
